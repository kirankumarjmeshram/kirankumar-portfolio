      ...
      >
        ...
        >
          ...
          <h1>
            ...
            development. Certified with a strong grasp of modern web
            technologies, highly skilled in crafting robust and user-friendly
            applications using MongoDB, Express.js, React.js, and Node.js. Also,
            possess a foundational understanding of blockchain and Salesforce.
            {/* MERN-Stack Web Developer */}
            {/* and make a significant contribution to its innovations. */}
          </h1>
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/file/d/1mcFIfq97l-iDBzUj2qI-BBw49PNwRDs5/view?usp=sharing" // Resume
              target="blank"
            >
              <Button
                text={
        ...
        >
          <img
            src="https://avatars.githubusercontent.com/u/85862711?v=4"
            alt=""
          />
        </div>
      </div>
